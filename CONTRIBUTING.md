...
Thank you for considering contributing to GrocARy! Please follow these guidelines to ensure smooth collaboration.
...
1. Create feature branches for each task from the issue tracker.
...
3. Types:
   ...
   - `chore`: Code cleanup.
4. Example: `feat(ar)!: update product tracking algorithm`
...
Follow React Native and TypeScript naming conventions as much as possible. Resource: [https://medium.com/@mirazhs/naming-conventions-in-next-js-boosting-seo-and-code-maintainability-d4150fe7e6e](https://medium.com/@mirazhs/naming-conventions-in-next-js-boosting-seo-and-code-maintainability-d4150fe7e6e)
